...
export default function LinkCard({ label, href, icon, count = 0, onClick }: LinkCardProps) {
  return (
    <a
      href={href}
      target="_blank"
    ...
    >
      ...
      <span className="text-xs font-normal text-[#8a7566] dark:text-[#b7a495]">{count}회</span>
    </a>
  );
}
